...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const SUPPLEMENTAL_REPOS = [
        ...
        { name: 'azure-budget-iac', html_url: 'https://github.com/Devopstrio/azure-budget-iac', description: 'Enterprise Azure budget management and cost alerting framework built using Bicep Infrastructure as Code.', category: 'multicloud', language: 'Bicep', stargazers_count: 24, pushed_at: '2026-07-28T10:00:00Z' },
        { name: 'azure-budget-as-code-poc', html_url: 'https://github.com/Devopstrio/azure-budget-as-code-poc', description: 'Proof of Concept for managing Azure subscription budgets using Bicep Infrastructure as Code.', category: 'multicloud', language: 'Bicep', stargazers_count: 19, pushed_at: '2026-07-27T10:00:00Z' },
        { name: 'azure-enterprise-landing-zone-starter', html_url: 'https://github.com/Devopstrio/azure-enterprise-landing-zone-starter', description: 'Microsoft Cloud Adoption Framework CAF Azure Enterprise Landing Zone starter blueprint.', category: 'landing-zone', language: 'TypeScript', stargazers_count: 38, pushed_at: '2026-07-26T10:00:00Z' },
        { name: 'azure-migrate-extension', html_url: 'https://github.com/Devopstrio/azure-migrate-extension', description: 'Devopstrio Azure Migrate accelerator for enterprise workload migration and discovery.', category: 'landing-zone', language: 'TypeScript', stargazers_count: 29, pushed_at: '2026-07-25T10:00:00Z' },
        { name: 'azure-openai-secure-reference', html_url: 'https://github.com/Devopstrio/azure-openai-secure-reference', description: 'Secure reference architecture for Azure OpenAI Service with private endpoints and VNet isolation.', category: 'ai', language: 'TypeScript', stargazers_count: 41, pushed_at: '2026-07-24T10:00:00Z' },
        { name: 'azure-openai-terraform', html_url: 'https://github.com/Devopstrio/azure-openai-terraform', description: 'Terraform deployment accelerator for Azure OpenAI endpoints, key vaults, and cognitive services.', category: 'ai', language: 'TypeScript', stargazers_count: 33, pushed_at: '2026-07-23T10:00:00Z' },
        { name: 'devopstrio-landing-zone', html_url: 'https://github.com/Devopstrio/devopstrio-landing-zone', description: 'Enterprise-ready multi-cloud landing zone foundation for AWS, Azure, and GCP workloads.', category: 'landing-zone', language: 'TypeScript', stargazers_count: 52, pushed_at: '2026-07-22T10:00:00Z' },
